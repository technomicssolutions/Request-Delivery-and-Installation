...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseInformation.end_user_delivery_location'
        db.delete_column(u'web_purchaseinformation', 'end_user_delivery_location')

        # Adding field 'PurchaseInformation.address'
        db.add_column(u'web_purchaseinformation', 'address',
        ...
        # Adding field 'PurchaseInformation.contact_number'
        db.add_column(u'web_purchaseinformation', 'contact_number',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'PurchaseInformation.end_user_delivery_location'
        db.add_column(u'web_purchaseinformation', 'end_user_delivery_location',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PurchaseInformation.address'
        db.delete_column(u'web_purchaseinformation', 'address')

        # Deleting field 'PurchaseInformation.contact_person'
        db.delete_column(u'web_purchaseinformation', 'contact_person')

        # Deleting field 'PurchaseInformation.contact_number'
        db.delete_column(u'web_purchaseinformation', 'contact_number')
