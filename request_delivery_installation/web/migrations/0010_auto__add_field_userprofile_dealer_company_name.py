...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.dealer_company_name'
        db.add_column(u'web_userprofile', 'dealer_company_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.dealer_company_name'
        db.delete_column(u'web_userprofile', 'dealer_company_name')
