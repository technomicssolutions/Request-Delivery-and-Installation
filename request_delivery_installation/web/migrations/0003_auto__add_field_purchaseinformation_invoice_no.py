...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseInformation.invoice_no'
        db.add_column(u'web_purchaseinformation', 'invoice_no',
                      self.gf('django.db.models.fields.CharField')(default='1234', max_length=30),
                      keep_default=False)
