...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseInformation.delivered_status'
        db.add_column(u'web_purchaseinformation', 'delivered_status',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseInformation.delivered_status'
        db.delete_column(u'web_purchaseinformation', 'delivered_status')
