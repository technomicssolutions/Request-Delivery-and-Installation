...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PurchaseInformation.delivery_requested_charge'
        db.add_column(u'web_purchaseinformation', 'delivery_requested_charge',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PurchaseInformation.installation_requested_express_delivery'
        raise RuntimeError("Cannot reverse this migration. 'PurchaseInformation.installation_requested_express_delivery' and its values cannot be restored.")
        # Deleting field 'PurchaseInformation.date_change_charge'
        db.delete_column(u'web_purchaseinformation', 'date_change_charge')

        # Deleting field 'PurchaseInformation.delivery_requested_charge'
        db.delete_column(u'web_purchaseinformation', 'delivery_requested_charge')
