...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_purchaseinformation', (
            ...
            ('invoice_no', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('block_house_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('floor_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('building_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('street_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('telephone_number', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
    ...
    models = {
        ...
        u'web.purchaseinformation': {
            ...
            'invoice_no': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
